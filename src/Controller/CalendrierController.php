...
class CalendrierController extends AbstractController
{
     ...
     */
    public function editC(CalendrierRepository $repository, Request $request): Response
    {
        $uid = $request->getSession()->get('id');
        ...
        if ($form->isSubmitted())
        {
            ...
            return $this->redirectToRoute('editC');
        }
     ...
     */
    public function deletedc($id, CalendrierRepository $repository): Response
    {
